...
const LoginForm = ({ onSwitch }) => {
  ...
  return (
    <form onSubmit={handleSubmit} className="space-y-4">
      ...
      <button
        type="button"
        className="w-full btn-secondary flex items-center justify-center gap-2 mt-3 bg-white hover:bg-slate-50 text-slate-900 border border-slate-200 font-semibold shadow-sm py-3.5"
        onClick={() => alert("Google OAuth Mocked")}
      >
