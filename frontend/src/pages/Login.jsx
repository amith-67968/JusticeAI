...
export default function Login() {
  ...
  return (
    <div className="flex items-center justify-center p-4 w-full h-full relative">
      ...
      >
        ...
        <motion.button
          ...
          type="button"
          onClick={() => alert('Google Social Sign In Trapped')}
          className="bg-white/10 hover:bg-white/20 text-white font-medium py-3 rounded-xl w-full mt-4 flex items-center justify-center gap-2 border border-white/10 transition shadow-lg"
        >
        ...
        >
          Don't have an account? <Link to="/signup" className="text-white hover:text-blue-400 font-medium transition-colors">Sign up</Link>
        </motion.div>
      </motion.div>
    </div>
  );
